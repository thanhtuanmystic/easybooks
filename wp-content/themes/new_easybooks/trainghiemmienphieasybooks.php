<?php /* Template Name: Landing Page: Trải nghiệm miễn phí EasyBooks */ ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <style>
        * {
        ...
        #hero {
            background-image: url(https://easybooks.vn/wp-content/uploads/2024/08/Group-2609652.png);
            background-repeat: no-repeat;
            background-size: cover;
            padding-top: 30px;
        }

        #hero .hero-content-right form {
            padding: 32px;
            border-radius: 16px;
        ...
        #hero .hero-content-right form .form-title {
        ...
        #hero .hero-content-right form .form-row {
            margin-bottom: 16px;
            width: 100%;
        }

        #hero .hero-content-right form .form-row input {
            padding: 8px 16px;
            border-radius: 6px;
        ...
        #hero .hero-content-right form .form-sub-title {
        ...
        #hero .hero-content-right form .form-sub-title span {
            color: var(--white, #FFF);
        }

        #hero .hero-content-right form .hero-form-btn {
            border-radius: 6px;
            background: var(--Backgrounds-Primary, #FFF);
            box-shadow: 0px 4px 5.8px 0px rgba(237, 72, 41, 0.30);
            margin-top: 32px;
        }

        #hero .hero-content-right form .hero-form-btn button {
            padding: 10px 40px;
            background: var(--Gradient, linear-gradient(180deg, #F37B20 0%, #EC3E2B 100%));
        ...
        #number .number-box {
            ...
            border: 1px solid var(--Gradient, #F37B20);
            background: var(--Backgrounds-Primary, #FFF);
            box-shadow: 5px 4px 9.4px 0px rgba(240, 95, 37, 0.25);
            display: flex;
            justify-content: center;
            align-items: center;
            flex-direction: column;
        ...
        #number .number-box .number-text span {
            background: var(--Gradient, linear-gradient(180deg, #F37B20 0%, #EC3E2B 100%));
            background-clip: text;
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
        ...
        #feedback .feedback-box .feedback-info .feedback-name {
            font-size: 18px;
            font-weight: 700;
        }
        ...
        #form_bottom .slogan {
            ...
            text-shadow: 0px 3px 14.1px rgba(233, 88, 12, 0.10);
            font-size: 24px;
            font-style: normal;
            font-weight: 700;
            line-height: 32px;
    ...
    <section id="header">
        <div class="container">
            <div class="header-box">
                ...
                <a href="tel:  0766 074 666" class="form-button"> <button> 0766 074 666</button> </a>
            </div>
        </div>
    </section>
    <section id="hero">
            ...
            <div class="row d-flex align-items-center gy-4">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="hero-content-right">
                        <form id="form_hero_validate" action="../form-handle" method="POST">
                            <div class="form-title">Dùng thử miễn phí <br>
                                Phần mềm Kế toán EasyBooks</div>
                            <div class="form-sub-title">
                                Duy nhất cho <span>100 khách hàng</span> đăng ký đầu tiên
                            </div>
                            <div class="form-row">
                                <input type="text" placeholder="Họ và tên" class="form-control" name="hoten">
                            </div>
                            <div class="form-row">
                            ...
                            <input type="text" hidden value="trainghiemmienphi" name="trainghiemmienphi">
                            <div class="text-center hero-form-btn rise-shake"> <button type="submit">Nhận tư
                                    vấn</button></div>
                        </form>
                    </div>
                </div>
    ...
    <section id="why_easybooks">
        <div class="container">
            ...
            <div style="margin-bottom: 50px" class="d-flex justify-content-center align-items-center">
                <a href="#hero" class="form-button scroll-link"> Nhận demo ngay </a>
            </div>
            <div class="why-box">
                <div class="why-row img-right">
                    <div class="row gy-4 d-flex justify-content-center align-items-center">
                      ...
                      " alt="" />
                                ...
                                <div class="why-btn">
                                    <a href="#hero" class="form-button scroll-link"> Dùng thử miễn phí </a>
                ...
                <div class="col-lg-6 d-flex" style="justify-content: right">
                    <form action="../form-handle" method="POST" class="form-bottom" id="form_bottom_validate">
                        <div class="form-title">Dùng thử miễn phí <br>
                            Phần mềm Kế toán EasyBooks</div>
                        <div class="form-sub-title">
                            Duy nhất cho <strong>100 khách hàng</strong> đăng ký đầu tiên
                        </div>
                        <div class="form-info">
                            <div class="form-row">
